                ...
                <div class="row g-3">
                    <div class="col-lg-3 col-md-6 me-auto">
                        <div class="ms-auto position-relative">
                            <a href="{{ route('generate-excel-status-rents.complete') }}" class="btn btn-success"> Excel</a>
                            <a href="{{ route('generate-pdf-status-rents.complete') }}" class="btn btn-danger">PDF</a>
