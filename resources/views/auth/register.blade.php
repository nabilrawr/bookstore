                   ...
                   <div class="login-separater text-center mb-4"> <span>OR SIGN UP WITH EMAIL</span>
                     ...
                     <div class="row g-3">
                       ...
                       <div class="col-12">
                         ...
                         <div class="ms-auto position-relative">
                           <div class="position-absolute top-50 translate-middle-y search-icon px-3"></i></div>
                           <input id="ic" type="text" class="form-control @error('ic') is-invalid @enderror" name="ic" maxlength="12" value="{{ old('ic') }}" placeholder="Enter your IC. Example : 990131045045 (without -)" required autocomplete="ic">
                         </div>
                       </div>
                       <div class="col-12">
                       ...
                       <div class="col-12">
                        ...
                        <div class="ms-auto position-relative">
                          <div class="position-absolute top-50 translate-middle-y search-icon px-3"></i></div>
                          <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" maxlength="11" value="{{ old('phone') }}" placeholder="Enter your phone number" required autocomplete="phone">
                        </div>
                      </div>
                      <div class="col-12">
                        ...
                        <div class="ms-auto position-relative">
                          <div class="position-absolute top-50 translate-middle-y search-icon px-3"></i></div>
                          <textarea class="form-control @error('address') is-invalid @enderror" name="address" rows="4" required autocomplete="address" placeholder="Enter your address" >{{ old('address' )}}</textarea>
                        </div>
                      </div>
                      <div class="col-12">
