                        ...
                        <div class="card shadow rounded-0 overflow-hidden">
                            <div class="row g-0">
                                <div class="col-lg-6 bg-login d-flex align-items-center justify-content-center">
                                    <img src="{{ asset('template/assets/images/error/auth-img-7.png') }}"
                                        class="img-fluid" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <div class="card-body p-4 p-sm-5">
                                        ...
                                        <form class="form-body" method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-12">
                                                    <label for="inputChoosePassword" class="form-label">Phone
                                                        Number</label>
                                                    <div class="ms-auto position-relative">
                                                        <div
                                                            class="position-absolute top-50 translate-middle-y search-icon px-3">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="ms-auto position-relative">
                                                        ...
                                                        <textarea class="form-control @error('address') is-invalid @enderror" name="address" rows="4" required
                                                            autocomplete="address" placeholder="Enter your address">{{ old('address') }}</textarea>
